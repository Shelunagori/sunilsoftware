	...
	<div class="col-md-8">
		<div class="portlet light ">
			...
			<div class="portlet-body">
				<?= $this->Form->create($customer,['id'=>'form_sample_2']) ?>
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="col-md-8" style="padding-left: 0px;padding-right: 0px;vertical-align: top !important;">
									<div class="form-group" >
								...
								<div class="col-md-4" style="padding-left: 0px;padding-right:0;vertical-align: top !important;">
									...
									<?php $option =[['value'=>'Dr','text'=>'Dr'],['value'=>'Cr','text'=>'Cr']];
										...
										echo $this->Form->control('debit_credit',['id'=>'cr_dr','class'=>'form-control input-sm cr_dr','label'=>false, 'options' => $option,'value'=>@$check,]);
										?>
								</div>
								<div class="form-group">
