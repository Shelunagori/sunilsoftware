						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<?php echo $this->Form->control('accounting_group_id',['class'=>'form-control input-sm select2me','label'=>false,'empty'=>'-Primary Group-', 'options' => $accountingGroups,'required'=>'required']); ?>
								</div>
							</div>
						</div>
					</div>
