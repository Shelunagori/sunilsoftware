						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<?php echo $this->Form->control('name',['class'=>'form-control input-sm','placeholder'=>'Company Name','label'=>false,'autofocus','required'=>'required']); ?>
								</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<?php echo $this->Form->control('financial_year_valid_to',['class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy', 'label'=>false,'placeholder'=>'DD-MM-YYYY','type'=>'text','value'=>'','required'=>'required']); ?>
								</div>
								<div class="form-group">
									<label>Pan</label>
