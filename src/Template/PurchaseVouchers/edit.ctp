 ...
 */
$this->set('title', 'Edit Purchase Voucher');
?>
<div class="row">
	<div class="col-md-9">
					...
					<div class="row">
						<div class="table-responsive">
							<table id="main_table" class="table table-condensed table-bordered" style="margin-bottom: 4px;" width="100%">
								...
								<?php $i=0;foreach($purchaseVoucher->purchase_voucher_rows as $purchase_voucher_row){
									if($i==0)
									{
								?>
									...
									<tr class="main_tr" class="tab">
										...
										<td width="15%">
											<?php echo $this->Form->input('ledger_id', ['options'=>@$Debitledgers,'label' => false,'class' => 'form-control input-medium','required'=>'required','value'=>$purchase_voucher_row->ledger_id]);
											echo $this->Form->input('purchase_voucher_rows.'.$i.'.id', ['type'=>'hidden','value'=>$purchase_voucher_row->id]);
											?>
										</td>
										<td width="25%">
									...
									<tr class="main_tr" class="tab">
										<td width="10%">
											...
											$display_for_credit ="";
											$display_for_debit  ="";
											if(!empty($purchase_voucher_row->debit))
											{
												$value = "Dr";
												$display_for_credit = "display:none";
											}
											else
											{
												$value = "Cr";
