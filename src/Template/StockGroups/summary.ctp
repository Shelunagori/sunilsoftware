 ...
 */
$this->set('title', 'Stock Group Summary');
?>
<div class="row">
	<div class="col-md-12">
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green-sharp bold ">Stock Group Summary</span>
				</div>
				<div class="actions">
					...
					<table class="table table-bordered table-hover table-condensed" width="100%" border="1">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:right">
									<?php if(@$ledgerBalances[$Item->id]<0){
										echo abs(@$ledgerBalances[$Item->id]);
										$totalCr+=abs(@$ledgerBalances[$Item->id]);
									} ?>
								</td>
								<td style="text-align:right">
									<?php echo $closingBalances[$Item->id]['value']; ?>
								</td>
							</tr>
							<?php } ?>
						</tbody>
