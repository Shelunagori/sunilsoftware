...
use App\Model\Table\ContraVouchersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ContraVouchersTable Test Case
 */
class ContraVouchersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ContraVouchersTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ContraVouchers') ? [] : ['className' => ContraVouchersTable::class];
        $this->ContraVouchers = TableRegistry::get('ContraVouchers', $config);
    }
