...
class PurchaseVouchersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'supplier_invoice_no' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'supplier_invoice_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'narration' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'voucher_amount' => ['type' => 'decimal', 'length' => 15, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'supplier_invoice_no' => 'Lorem ipsum dolor sit amet',
            'supplier_invoice_date' => '2017-08-24',
